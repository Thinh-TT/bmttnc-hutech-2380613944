...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(240, 40, 241, 31))
        font = QtGui.QFont()
        ...
        self.label_3.setGeometry(QtCore.QRect(30, 200, 81, 21))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.textMatrix.setGeometry(QtCore.QRect(160, 450, 421, 64))
        ...
        self.pushEncrypt.setGeometry(QtCore.QRect(350, 380, 111, 41))
        font = QtGui.QFont()
        font.setPointSize(18)
        self.pushEncrypt.setFont(font)
        self.pushEncrypt.setObjectName("pushEncrypt")
        self.pushDecrypt = QtWidgets.QPushButton(self.centralwidget)
        self.pushDecrypt.setGeometry(QtCore.QRect(470, 380, 111, 41))
        font = QtGui.QFont()
        font.setPointSize(18)
        self.pushDecrypt.setFont(font)
        self.pushDecrypt.setObjectName("pushDecrypt")
        self.pushCreateMatrix = QtWidgets.QPushButton(self.centralwidget)
        self.pushCreateMatrix.setGeometry(QtCore.QRect(160, 380, 181, 41))
        font = QtGui.QFont()
        font.setPointSize(18)
        self.pushCreateMatrix.setFont(font)
        self.pushCreateMatrix.setObjectName("pushCreateMatrix")
        self.label_6 = QtWidgets.QLabel(self.centralwidget)
        self.label_6.setGeometry(QtCore.QRect(0, 0, 421, 31))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_6.setText(_translate("MainWindow", "Tran Truong Thinh - 2380613944"))
